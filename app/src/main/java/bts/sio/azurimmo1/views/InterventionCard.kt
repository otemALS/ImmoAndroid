...
fun InterventionCard(intervention: Intervention) {
    Card(
        ...
        Column(modifier = Modifier.padding(16.dp)) {
            Text(text = "Description: ${intervention.description}", style = MaterialTheme.typography.bodyLarge)
            Text(text = "Date: ${intervention.date}", style = MaterialTheme.typography.bodyMedium)
            Text(text = "Réalisé par: ${intervention.realisePar}", style = MaterialTheme.typography.bodyLarge)
        }
    }
}
